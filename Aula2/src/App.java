...
public class App {
    ...
    public static void main(String[] args) {
        System.out.println("Respostas sobre estruturas de dados:");
        System.out.println("-------------------------------------");
        respostaRestaurante();
        System.out.println("-------------------------------------");
        respostaInstagramBusca();
        System.out.println("-------------------------------------");
        respostaInstagramInsercao();
    }

    public static void respostaRestaurante() {
        System.out.println("Questao 1 - Lista de pedidos em um restaurante");
        System.out.println("Contexto: Garcons adicionam pedidos no final da lista e chefs retiram do inicio.");
        System.out.println("Estrutura recomendada: Lista encadeada (ou LinkedList configurada como fila).");
        System.out.println("Justificativa:");
        System.out.println("- Lista encadeada permite adicionar no final e remover do inicio com complexidade O(1), se implementada como fila.");
        System.out.println("- Array tem custo O(n) para remover do inicio, pois exige deslocar todos os elementos.");
        System.out.println("- Adicionar no final em um array pode ser caro (O(n)) se for necessario redimensionar.");
        System.out.println("- Como o comportamento e de fila (FIFO - primeiro a entrar, primeiro a sair), lista encadeada e mais eficiente.");
    }

    public static void respostaInstagramBusca() {
        System.out.println("Questao 2 - Lista de usuarios no Instagram (buscas frequentes)");
        System.out.println("Contexto: Muitas buscas por nome de usuario, com necessidade de acesso aleatorio rapido ao meio da lista.");
        System.out.println("Estrutura recomendada: Array (ou ArrayList).");
        System.out.println("Justificativa:");
        System.out.println("- Array permite acesso aleatorio em tempo constante O(1), ideal para acessar elementos no meio da lista por indice.");
        System.out.println("- Lista encadeada tem custo O(n) para acesso aleatorio, pois exige percorrer os nos ate o ponto desejado.");
        System.out.println("- Como ha muitas buscas e acesso rapido ao meio da lista e necessario, array e a melhor escolha.");
    }

    public static void respostaInstagramInsercao() {
        System.out.println("Questao 3 - Desvantagens de usar array para insercoes no Instagram");
        System.out.println("Contexto: Muitas inscricoes de novos usuarios, usando array para armazenar a lista.");
        System.out.println("Desvantagens de um array em relacao a insercoes:");
        System.out.println("- Tamanho fixo: Arrays em Java tem tamanho fixo. Se o array estiver cheio, nao e possivel adicionar novos usuarios diretamente.");
        System.out.println("- Redimensionamento: Para adicionar mais usuarios, e necessario criar um novo array maior e copiar todos os elementos, com custo O(n).");
        System.out.println("- Insercao no meio ou inicio: Inserir um usuario no meio ou inicio exige deslocar os outros elementos, com custo O(n).");
        System.out.println("- Custo de memoria: Arrays podem desperdicar memoria se alocados com tamanho grande, ou exigir redimensionamentos frequentes se pequenos.");
        System.out.println("O que acontece ao adicionar novos usuarios em um array?");
        System.out.println("- Se o array tiver espaco, o novo usuario e adicionado na proxima posicao livre, com custo O(1).");
        System.out.println("- Se o array estiver cheio, um novo array maior e criado, todos os dados sao copiados, e o usuario e adicionado, com custo O(n).");
        System.out.println("- Em ArrayList (baseado em array), esse redimensionamento e automatico, mas ainda tem o custo de copia quando o limite e atingido.");
    }
